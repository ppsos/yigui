				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td class="text-l"><u style="cursor:pointer" class="text-primary"><?php echo $vo['title']; ?></u></td>
							<td><?php echo $vo['category']; ?></td>
							<td><?php echo date("Y-m-d",$vo['create_time']); ?></td>
							<td><?php echo $vo['view']; ?></td>
							<td class="td-status"><?php if($vo['status'] == 1): ?><span class="label label-success radius">已发布</span><?php else: ?><span class="label label-defaunt radius">已下架</span><?php endif; ?></td>
							<td class="f-14 td-manage">
								...
								<?php endif; ?>
								<a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','<?php echo url('article/edit',array('id'=>$vo['id'])); ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
