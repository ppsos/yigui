<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"G:\WWW_GIT\yigui\public/../application/admin\view\article\edit.html";i:1569429596;s:55:"G:\WWW_GIT\yigui\application\admin\view\public\top.html";i:1569411795;s:58:"G:\WWW_GIT\yigui\application\admin\view\public\footer.html";i:1569411795;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form class="form form-horizontal" id="form-article-edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="category_id" class="select">
					...
					<option <?php if($res['category_id'] == $vo['id']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					<input name="is_index" <?php if($res['is_index'] == 1): ?>checked<?php endif; ?> type="checkbox" id="checkbox-is_index">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					<input name="status" <?php if($res['status'] == 1): ?>checked<?php endif; ?> type="checkbox" id="checkbox-pinglun">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<div id="image">
						<?php if($res['cover_id']): ?>
							<img style='display:block;width:200px;height:80px;' src="<?php echo get_cover($res['cover_id'],'path'); ?>" alt="">
							<input type="hidden" id="cover_id" name="cover_id" value="<?php echo $res['cover_id']; ?>">
						<?php endif; ?>
					</div>
				</div>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" name="content" type="text/plain" style="width:100%;height:400px;"><?php echo $res['content']; ?></script> 
			</div>
		</div>
		<div class="row cl">
